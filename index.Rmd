...
engines. We hope that this book will help proteomics researchers
tailoring their statistical analysis workflow to their
...
biomarker discovery. This `msqrob2` book provides a set of (mixed)
model-based workflows tailored toward differential abundance analysis
for label-free as well as labeled MS-based proteomics data. The key
features of `msqrob2` workflows
are:
