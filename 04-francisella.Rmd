...
3. [Summarisation](#sec-summarisation) to protein level. We use the 
   robust summary approach to infer protein-level data from
...
residuals). More details on mixed models can be found in 

**TODO** PROVIDE REFERENCE TO ADVANCED VIGNETTE!
...
the francisella cultur effect as a random effect instead.
